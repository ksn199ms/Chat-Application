        ...
        <div
          className={`${
            message.sender !== selectedChatData._id
              ? "bg-[#8417ff]/5 text-[#8417ff]/90 border-[#8417ff]/50"
              : "bg-[#2a2b33]/5 text-white/80 border-[#ffffff]/20"
          } border inline-block p-4 rounded my-1 max-w-[85%] md:max-w-[50%] break-words`}
        >
          {message.content}
        </div>
      )}
        ...
        <div
          className={`${
            message.sender !== selectedChatData._id
              ? "bg-[#8417ff]/5 text-[#8417ff]/90 border-[#8417ff]/50"
              : "bg-[#2a2b33]/5 text-white/80 border-[#ffffff]/20"
          } border inline-block p-4 rounded my-1 max-w-[85%] md:max-w-[50%] break-words cursor-pointer`}
        >
          {checkIfImage(message.fileUrl) ? (
            <div>
              <img
            ...
            <div className="flex items-center justify-between gap-2">
              <span className="text-white/8 text-2xl bg-black/20 rounded-full p-3">
                <MdFolderZip />
              </span>
          ...
          <div
            className={`${
              message.sender._id === userInfo.id
                ? "bg-[#8417ff]/5 text-[#8417ff]/90 border-[#8417ff]/50"
                : "bg-[#2a2b33]/5 text-white/80 border-[#ffffff]/20"
            } border inline-block p-4 rounded my-1 max-w-[85%] md:max-w-[50%] break-words ml-9`}
          >
            {message.content}
          </div>
        )}
        ...
        {message.sender._id !== userInfo.id ? (
          <div className="flex items-center justify-start gap-3">
            <Avatar className="w-8 h-8 rounded-full overflow-hidden">
              ...
              <AvatarFallback
                className={`uppercase h-8 w-8 text-lg border-[1px] flex items-center justify-center font-semibold rounded-full ${getColor(
            ...
            <div className="flex flex-col">
              <p className="text-white/30 text-[0.95rem]">{message.sender.email}</p>
              <p className="text-xs text-gray-600">{moment(message.timestamp).format("LT")}</p>
            </div>
          </div>
        ) : (
          <div className="text-xs text-gray-600">{moment(message.timestamp).format("LT")}</div>
