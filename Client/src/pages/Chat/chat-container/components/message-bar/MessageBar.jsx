...
//                 setIsUploading(true)
//                 const response = await apiClient.post(UPLOAD_FILE,formData,{withCredentials : true,onUploadProgress : data => {setFileUploadProgress(Math.round((100 * data.loaded) / data.total))}})
...
const MessageBar = () => {
    ...
    return (
        <div className='h-[10vh] bg-[#1c1d25] flex justify-center items-center px-4 sm:px-8 mb-8 gap-4 sm:gap-6 pb-4 sm:pb-6 md:pb-safe'>
